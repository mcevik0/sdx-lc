...
if __name__ == '__main__':
    ...
    amlight_ctlr = sys.argv[1] if len(sys.argv) > 1 else '172.31.2.93'
    # amlight_ctlr = sys.argv[1] if len(sys.argv) > 1 else '3.218.56.104'
    sax_ctlr = sys.argv[2] if len(sys.argv) > 2 else '172.31.2.69'
    # sax_ctlr = sys.argv[2] if len(sys.argv) > 2 else '3.219.254.70'
    tenet_ctlr = sys.argv[3] if len(sys.argv) > 3 else '172.31.12.138'
